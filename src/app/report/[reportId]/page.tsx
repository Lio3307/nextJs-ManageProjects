...
<div className="p-4">
  <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8">
    <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-blue-50 border-b border-gray-200">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        {(session.user.id === detailReport.userId || session.user.id === getProjectOwnerId.userId) && (
    ...
    <div className="px-6 py-5">
      ...
      <div className="space-y-3">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="text-xs font-semibold text-gray-700 uppercase tracking-wide">Report Title</h3>
        </div>
  ...
  <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8">
    <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
      <div className="flex items-center space-x-2">
        <div className="w-2 h-2 bg-sky-500 rounded-full"></div>
        <h3 className="text-xs font-semibold text-gray-700 uppercase tracking-wide">Report Details</h3>
      </div>
    </div>
  ...
  <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
    <div className="px-6 py-4 bg-gradient-to-r from-indigo-50 to-purple-50 border-b border-gray-200">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-900">Comments & Discussion</h3>
          <p className="text-sm text-gray-600">Share feedback and collaborate</p>
        </div>
      </div>
    </div>
