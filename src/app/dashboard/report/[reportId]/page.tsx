...
import CommentForm from "@/components/dashboard-components/comment-component/comment-form";
      ...
      <div className="p-4 lg:p-6 space-y-6 lg:space-y-8">
              ...
              <div className="flex items-center space-x-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  <BreadcrumbWithCustomSeparator
                    ...
                    link={`/dashboard/task/${detailReport.taskId}`}
          ...
          <div className="space-y-4 mb-8">
            <div className="flex items-center ml-4 space-x-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-xs font-bold text-gray-700 dark:text-neutral-400 uppercase tracking-wider">
                  Report Title
                </h3>
              </div>
            </div>
        ...
        <div className="bg-white dark:bg-neutral-950 rounded-2xl shadow-xl border border-gray-200 dark:border-neutral-800 overflow-hidden transition-colors duration-300">
          <div className="px-6 lg:px-8 py-6 border-b border-gray-200 dark:border-neutral-800 flex items-start space-x-4">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-xl lg:text-2xl font-bold text-black dark:text-neutral-50 mb-1">
                Comments & Discussion
              </h3>
