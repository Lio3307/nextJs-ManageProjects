        ...
        <div className="px-6 lg:px-8 py-6 bg-neutral-50 dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 lg:w-14 lg:h-14 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl flex items-center justify-center">
              <Plus
                className="w-6 h-6 lg:w-7 lg:h-7 text-neutral-900 dark:text-neutral-100"
                strokeWidth={2}
              />
            </div>
            <div className="flex-1 min-w-0">
              <h2 className="text-xl lg:text-2xl font-bold text-neutral-900 dark:text-neutral-100">
                Create New Task
              </h2>
          ...
          <form className="space-y-8" action={handleTask}>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs px-2 py-1 rounded border border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-neutral-300">
                  Rich Editor
                </span>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-8 border-t border-neutral-200 dark:border-neutral-700">
              ...
              <Link
                href={`/dashboard/project/${idProject}`}
                className="px-3 py-1 flex items-center justify-center border border-neutral-400 dark:border-neutral-600 rounded-xl hover:bg-neutral-100 dark:hover:bg-neutral-800"
              >
                <ArrowLeft /> Cancel
              </Link>
            </div>
